...
<html lang="en">
  <head>
    ...
    <title>La hipotenusa de un triángulo rectángulo</title>
  </head>

  <body>
  <div class="container">

        <h1>La hipotenusa de un triángulo rectángulo</h1>

        <form action="{{ route('extriangulo.soluciontri') }}" method="post">
        @csrf
